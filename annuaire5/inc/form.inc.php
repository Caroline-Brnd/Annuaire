                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="annuaire.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger">Supprimer</a></td>
                                <td><a href="annuaire.php?edit=<?php echo $row['id'] ?>" class="btn btn-info">Modifier</a></td>
                            </tr>
                            <?php endwhile; ?>
                        </tbody>
                    </table>
                ...
                <div class="col-md-4">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="tour">
                            ...
                            <!-- INSERT -->
                            <?php
                                include_once("inc/inserer.inc.php");
                            ?>
                        <hr>
                    </form>
                    <nav>
